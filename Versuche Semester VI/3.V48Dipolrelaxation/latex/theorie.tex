...
\section{Theorie}
	...
	\subsection{Depolarisationseffekte}
		...
		Da die Energieverteilung im Kristall durch die Boltzmann-Statistik $\propto\text{exp}\left(-\frac{W}{k_\text{B}T}\right)$ beschreiben wird, folgt für die Relaxationszeit:\\
		\begin{equation}
